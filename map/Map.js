/**
 * @fileoverview Implements the Map object.
...
MapIterator.prototype.next = function() {
    ...
    do {
        this._index += 1;
    } while (isUndefined(this._keys[this._index]) && this._index < this._length);
...
Map.prototype._setInitData = function(initData) {
    ...
    forEachArray(initData, function(pair) {
...
Map.prototype.keys = function() {
    return new MapIterator(this._keys, bind(this._getOriginKey, this));
};
...
Map.prototype.values = function() {
    return new MapIterator(this._keys, bind(this._getOriginValue, this));
};
...
Map.prototype.entries = function() {
    return new MapIterator(this._keys, bind(this._getKeyValuePair, this));
};
...
Map.prototype.forEach = function(callback, thisArg) {
    ...
    forEachArray(this._keys, function(key) {
        if (!isUndefined(key)) {
